...
├── tests/
│   └── test_rotten_tomatoes.py # 74 tests (all pure logic, no network/browser)
├── .github/
│   └── workflows/
